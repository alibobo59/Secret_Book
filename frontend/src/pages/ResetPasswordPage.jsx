...
const ResetPasswordPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setSuccess(response.message + ' Đang chuyển hướng đến trang đăng nhập...');
            ...
            <motion.div
                ...
                <div className="text-center">
                    ...
                    <p className="mt-2 text-gray-600 dark:text-gray-400">
                        Nhập mật khẩu mới cho tài khoản: <strong className="text-amber-600 dark:text-amber-500">{formData.email}</strong>
                    </p>
                </div>
