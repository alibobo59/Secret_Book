...
import { ChevronDown, ChevronUp, Download, Filter, Search, Calendar, User, Activity } from "lucide-react";
  ...
  const fetchAuditLogs = async () => {
    try {
      ...
      if (modelType && modelId) {
        ...
        response = await api.get(`/audit-logs/${modelType}/${modelId}`, { params });
      } else {
        // Get all logs
