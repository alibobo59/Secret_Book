  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                      ...
                      >
                        <div className="flex items-start space-x-3">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-sm text-green-600 font-medium mt-1">${book.price}</p>
                            <Link
              ...
              <div className="bg-white rounded-lg shadow p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <span className="text-gray-900">{publisher.address || "Not provided"}</span>
                  </div>
                </div>
              </div>
        ...
        {activeTab === "audit" && (
          <AuditLogTable modelType="Publisher" modelId={id} className="mt-6" />
        )}
