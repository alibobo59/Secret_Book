...
// 🔁 Đổi {bookId} -> {id} để dùng cartItemId
Route::put('/cart/items/{id}', [CartController::class, 'updateItem'])->name('cart.update-item');
Route::delete('/cart/items/{id}', [CartController::class, 'removeItem'])->name('cart.remove-item');

// 🔁 Xóa nhiều theo cartItemId
Route::post('/cart/items/bulk-delete', [CartController::class, 'removeItems'])->name('cart.remove-items');
...
// Categories
Route::post('/categories', [CategoryController::class, 'store'])->name('categories.store'); //Tạo mới category.
Route::put('/categories/{category}', [CategoryController::class, 'update'])->name('categories.update'); //→ Cập nhật category theo ID.
Route::delete('/categories/{category}', [CategoryController::class, 'destroy'])->name('categories.destroy'); //Xoá category theo ID.
